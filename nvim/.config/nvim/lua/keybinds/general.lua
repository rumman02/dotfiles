...
local keybind_functions = require("keybinds.functions")
...
which_key.add({
  ...
  { "<localleader>T", group = "Terminal" },
	...
	{ "<localleader>Tx", function()  keybind_functions.close_terminal_buffer() end, desc = "Close" },
	{ "<localleader>Txc", function() keybind_functions.close_terminal_buffer() end, desc = "Current" },
	{ "<localleader>Txa", function() keybind_functions.close_all_terminal_buffers() end, desc  = "All" },
	--==================================================--
	--                       tabs                       --
	--==================================================--
